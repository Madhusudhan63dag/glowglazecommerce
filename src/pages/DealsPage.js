...
import { dealBanners, defaultDealBanner } from '../utils/data/banner'; // Import banner data
...
const DealsPage = () => {
  ...
  // Handle window resize for responsive banners
  useEffect(() => {
    const handleResize = () => {
  ...
  // Get banners for current deal from banner.js
  const banners = dealBanners[dealType] || defaultDealBanner;
  
  // Function to get the appropriate banner image URL based on screen size
