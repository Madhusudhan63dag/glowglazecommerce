...
import {aboutBanner} from '../utils/data/banner';
...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO title="About GlowGlaz - Our Mission & Vision | Ayurvedic Health Products" description="Learn about GlowGlaz's mission to provide authentic Ayurvedic and natural health solutions. Discover our story, values, and commitment to quality products." canonical="https://glowglaz.com/about" />
